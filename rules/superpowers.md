...
For Surch execution:
- repo rules and branch files win over generic skill workflow preferences
...
- replace `PLAN.md` plus `plan/NN_BRANCH_*.md` with another planning layout
- bypass allowed and forbidden path boundaries
- bypass verification gates
- replace branch execution files with ad hoc notes
...
- forcing a documentation structure that conflicts with Entropic-like branch files
