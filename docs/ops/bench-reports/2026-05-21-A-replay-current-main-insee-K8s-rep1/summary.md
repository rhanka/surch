...
Generated 2026-05-21T02:48:43Z.

## Artillery results (surch.bench.artillery.v1)

| Engine | Workload | p50 ms | p95 ms | p99 ms | max ms | issued | errors |
|---|---|---:|---:|---:|---:|---:|---:|
| elasticsearch | deces | 4.5 | 9.3 | 16.3 | 354.1 | 13170 | 0 |
| surch | deces | 1.9 | 3.5 | 5.0 | 25.0 | 13170 | 0 |
...
- artillery max ≤ 500 ms [art-os] : PASS (observed max = 354.1 ms)
...
- artillery max ≤ 500 ms [art-surch] : PASS (observed max = 25.0 ms)
