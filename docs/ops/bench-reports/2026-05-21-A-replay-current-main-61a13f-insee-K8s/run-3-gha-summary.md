...
- Run: https://github.com/rhanka/surch/actions/runs/26204062094
- Attempt: 1
...
Generated 2026-05-21T03:56:38Z.

## Artillery results (surch.bench.artillery.v1)

| Engine | Workload | p50 ms | p95 ms | p99 ms | max ms | issued | errors |
|---|---|---:|---:|---:|---:|---:|---:|
| elasticsearch | deces | 4.3 | 9.5 | 16.7 | 225.6 | 13170 | 0 |
| surch | deces | 2.1 | 3.6 | 5.0 | 36.8 | 13170 | 0 |
...
- artillery p95 ≤ 200 ms [art-os] : PASS (observed p95 = 9.5 ms)
- artillery max ≤ 500 ms [art-os] : PASS (observed max = 225.6 ms)
