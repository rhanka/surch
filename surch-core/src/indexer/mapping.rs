...
impl FieldMapper {
    pub fn map_document(mapping: &Mapping, fields: &std::collections::HashMap<String, crate::common::FieldValue>) -> Result<std::collections::HashMap<String, crate::common::FieldValue>, Error> {
    ...
    fn map_value(field_def: &FieldDefinition, value: &crate::common::FieldValue) -> Result<crate::common::FieldValue, Error> {
        Ok(value.clone())
    }

    pub fn infer_mapping(fields: &std::collections::HashMap<String, crate::common::FieldValue>) -> Mapping {
        ...
        for (name, value) in fields {
            let field_type = match value {
                ...
                crate::common::FieldValue::Array(arr) => {
